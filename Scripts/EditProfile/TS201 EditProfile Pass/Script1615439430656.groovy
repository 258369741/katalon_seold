...
WebUI.click(findTestObject('Object Repository/Page_dit profile/input__se_skill'))

WebUI.setText(findTestObject('Object Repository/Page_dit profile/input__se_skill'), 'milky boy')

WebUI.click(findTestObject('Object Repository/Page_dit profile/input__submit'))

WebUI.verifyTextPresent('milky boy', false)
