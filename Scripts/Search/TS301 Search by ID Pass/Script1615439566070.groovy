...
WebUI.navigateToUrl('http://localhost/seoldsk/index.php/seold/Login')
...
WebUI.setText(findTestObject('Object Repository/Page_SE Alumni/input__title'), '614259044')

WebUI.click(findTestObject('Object Repository/Page_SE Alumni/input__submit'))

WebUI.verifyTextPresent('ธนายุทธ', false)
